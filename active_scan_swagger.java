...
public class active_scan_swagger implements ScanCheck {
    ...
    public AuditResult activeAudit(HttpRequestResponse baseRequestResponse, AuditInsertionPoint auditInsertionPoint){
        ...
        String str_url="";
        if(url.getPort()==-1){
            str_url=url.getProtocol()+"://"+url.getHost()+"/swagger-ui.html";}
        else{
            str_url=url.getProtocol()+"://"+url.getHost()+":"+url.getPort()+"/swagger-ui.html";
        }
        ...
        List<AuditIssue> auditIssueList = code!=200 ? emptyList() : singletonList(
                AuditIssue.auditIssue("Sensitive information found:swagger-ui!",
                        str_url,
                        req.url(),
                        req.url(),
